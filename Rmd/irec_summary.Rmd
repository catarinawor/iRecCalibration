...
A few notes on the current data:
 ...
 - Initial data explorations, we have creel data for 2020, only. 
 - The creel data does not include the quality control, e.g. creel data for september may only include estimates up to labour day.
 - There are no 0's inputed in the creel data set - a revised version will be provided soon.
